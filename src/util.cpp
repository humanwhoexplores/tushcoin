...
const char * const BITCOIN_CONF_FILENAME = "tushcoin.conf";
const char * const BITCOIN_PID_FILENAME = "tushcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tushcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tushcoin";
#else
    // Unix
    return pathRet / ".tushcoin";
#endif
#endif
}
