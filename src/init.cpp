...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tushcoin-project/tushcoin>";
    const std::string URL_WEBSITE = "<https://tushcoin.org>";
