...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tushcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tushcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tushcoin transaction") + "\n" +
              "  tushcoin-tx [options] -create [commands]   " + _("Create hex-encoded tushcoin transaction") + "\n" +
              "\n";
