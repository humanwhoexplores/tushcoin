...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1620628204, 2000483923, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa70c7670e842b4f9a8dd4249ead225d53768f0724391bef639025c0c28bb5610"));
        assert(genesis.hashMerkleRoot == uint256S("0x8795b234d39b9bd616d60aa13ca7888ba5371af37b27ca7d29fa08c1ac49233a"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("3.131.1.112", "3.131.1.112", true));
        //vSeeds.push_back(CDNSSeedData("18.225.25.73", "18.225.25.73", true));
        // vSeeds.push_back(CDNSSeedData("tushcointools.com", "dnsseed.tushcointools.com"));
        // vSeeds.push_back(CDNSSeedData("tushcoinpool.org", "dnsseed.tushcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xa70c7670e842b4f9a8dd4249ead225d53768f0724391bef639025c0c28bb5610"))
        ...
        chainTxData = ChainTxData{
            ...
            1620628204, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1620628204, 678864, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3acffe4cb12b624082f421c1907c8d5de610b38ae45998eb0fd411d006cd3636"));
        assert(genesis.hashMerkleRoot == uint256S("0x8795b234d39b9bd616d60aa13ca7888ba5371af37b27ca7d29fa08c1ac49233a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("3.131.1.112", "3.131.1.112"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.tushcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x3acffe4cb12b624082f421c1907c8d5de610b38ae45998eb0fd411d006cd3636")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1620628204, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa968260100bc3d803f372f83b08f27b150cfdb0d941dc09f0d52eb7e01d9bb6c"));
        assert(genesis.hashMerkleRoot == uint256S("0x8795b234d39b9bd616d60aa13ca7888ba5371af37b27ca7d29fa08c1ac49233a"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xa968260100bc3d803f372f83b08f27b150cfdb0d941dc09f0d52eb7e01d9bb6c"))
        };
